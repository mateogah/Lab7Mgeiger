 ...
 * @author Matthew Geiger Java 2467 20210304
 */
public class RPSLSpock {
    ...
    /**
     * Determine if user selection is valid for game
     * @param pick user selection or rock paper scissors lizard spock
    ...
    /**
     * Randomly generate computer selection from set list
    ...
    /**
     * Determine if computer wins, comparing computer and user selections
     * @param c_pick randomly selected computer pick
     * @param h_pick user entered pick
     * @return return true value to determine computer win
     */
